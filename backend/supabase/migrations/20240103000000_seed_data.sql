...
BEGIN
  ...
  RETURNING id INTO chef1_id, chef2_id, chef3_id, chef4_id, chef5_id, chef6_id, chef7_id, chef8_id, chef9_id, chef10_id;
  ...
  INSERT INTO dishes (chef_id, name, description, price, cuisine_type, dietary_tags, available) VALUES
    ...
    (chef1_id, 'Carne Asada Plate', 'Grilled steak with rice, beans, and tortillas', 18.99, 'Mexican', ARRAY[], TRUE),
  ...
  INSERT INTO dishes (chef_id, name, description, price, cuisine_type, dietary_tags, available) VALUES
    ...
    (chef2_id, 'Dim Sum Platter', 'Assorted dumplings: pork shu mai, shrimp har gow, veggie buns', 16.99, 'Chinese', ARRAY[], TRUE),
  ...
  INSERT INTO dishes (chef_id, name, description, price, cuisine_type, dietary_tags, available) VALUES
    ...
    (chef4_id, 'Korean Fried Chicken', 'Crispy wings with sweet and spicy glaze', 15.99, 'Korean', ARRAY[], TRUE),
    (chef4_id, 'Bulgogi Bowl', 'Marinated beef over rice with kimchi', 16.99, 'Korean', ARRAY[], TRUE),
  ...
  INSERT INTO dishes (chef_id, name, description, price, cuisine_type, dietary_tags, available) VALUES
    (chef5_id, 'Classic Cheeseburger', 'Half-pound beef patty with cheese, lettuce, tomato', 13.99, 'American', ARRAY[], TRUE),
    ...
    (chef5_id, 'BBQ Pulled Pork Sandwich', 'Slow-cooked pork with coleslaw on brioche', 14.99, 'American', ARRAY[], TRUE);
  ...
  INSERT INTO dishes (chef_id, name, description, price, cuisine_type, dietary_tags, available) VALUES
    ...
    (chef7_id, 'Pepperoni Pizza', 'Classic pepperoni with mozzarella', 15.99, 'Italian', ARRAY[], TRUE),
  ...
  INSERT INTO dishes (chef_id, name, description, price, cuisine_type, dietary_tags, available) VALUES
    (chef8_id, 'Butter Chicken', 'Tender chicken in creamy tomato curry', 15.99, 'Indian', ARRAY[], TRUE),
  ...
  INSERT INTO dishes (chef_id, name, description, price, cuisine_type, dietary_tags, available) VALUES
    (chef9_id, 'Carbonara', 'Spaghetti with eggs, pecorino, guanciale', 16.99, 'Italian', ARRAY[], TRUE),
    (chef9_id, 'Pesto Penne', 'Fresh basil pesto with pine nuts', 14.99, 'Italian', ARRAY['vegetarian', 'nuts'], TRUE),
    (chef9_id, 'Lasagna Bolognese', 'Layers of pasta, meat sauce, béchamel', 17.99, 'Italian', ARRAY[], TRUE),
  ...
  INSERT INTO dishes (chef_id, name, description, price, cuisine_type, dietary_tags, available) VALUES
    (chef10_id, 'Fried Chicken', 'Crispy buttermilk fried chicken pieces', 14.99, 'American', ARRAY[], TRUE),
    (chef10_id, 'Collard Greens', 'Slow-cooked greens with smoked turkey', 8.99, 'American', ARRAY[], TRUE),
    ...
    (chef10_id, 'BBQ Ribs', 'Fall-off-the-bone ribs with house BBQ sauce', 19.99, 'American', ARRAY[], TRUE);
